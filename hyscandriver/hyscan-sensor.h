 ...
 * @set_channel: Функция устанавливает номер приёмного канала для указанного порта.
 * @set_latency: Функция устанавливает величину компенсации задержки при приёме данных портом.
